...
{
    void *ctx = (mbedtls_md2_context *)mbedtls_calloc( 1, sizeof( mbedtls_md2_context ) );
...
{
    void *ctx = (mbedtls_md4_context *)mbedtls_calloc( 1, sizeof( mbedtls_md4_context ) );
...
{
    void *ctx = (mbedtls_md5_context *)mbedtls_calloc( 1, sizeof( mbedtls_md5_context ) );
...
{
    void *ctx = (mbedtls_ripemd160_context *)mbedtls_calloc( 1, sizeof( mbedtls_ripemd160_context ) );
...
{
    void *ctx = (mbedtls_sha1_context *)mbedtls_calloc( 1, sizeof( mbedtls_sha1_context ) );
...
{
    void *ctx = (mbedtls_sha256_context *)mbedtls_calloc( 1, sizeof( mbedtls_sha256_context ) );
...
{
    void *ctx = (mbedtls_sha512_context *)mbedtls_calloc( 1, sizeof( mbedtls_sha512_context ) );
